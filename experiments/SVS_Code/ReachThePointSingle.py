...
"""
"""
results/save-ReachThePointAviarySingle-1-cc-aaa-pid-11.27.2022_19.15.22 400000
...
from gym_pybullet_drones.envs.multi_agent_rl.ReachThePointAviarySingle import ReachThePointAviarySingle
...
#                "pol3": (None, obs_space[3], act_space[3], {"agent_id": 3, }),
    ...
    stop = {
        "timesteps_total": 400000,  # 100000 ~= 10'
    ...
    if not ARGS.exp:
        ...
        if ACT in [ActionType.ONE_D_RPM, ActionType.ONE_D_DYN, ActionType.ONE_D_PID]:
            ...
            exit()
        start = time.time()
        for i in range(120 * int(temp_env.SIM_FREQ / temp_env.AGGR_PHY_STEPS)):  # Up to 6''
            #### Deploy the policies ###################################
            temp = {}
